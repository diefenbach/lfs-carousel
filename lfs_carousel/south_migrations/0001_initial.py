...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(
            "lfs_carousel_carouselitem",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
                (
                    "content_type",
                    self.gf("django.db.models.fields.related.ForeignKey")(
                        blank=True, related_name="carousel_item", null=True, to=orm["contenttypes.ContentType"]
                    ),
                ),
                ...
                (
                    "image",
                    self.gf("lfs.core.fields.thumbs.ImageWithThumbsField")(
                        blank=True,
                        max_length=100,
                        null=True,
                        sizes=((60, 60), (100, 100), (200, 200), (300, 300), (400, 400)),
                    ),
                ),
                (
                    "link",
